...
export const siteConfig: SiteConfig = {
	title: "RUI's Blog", // Site title, displayed in the browser tab and as the main heading on the homepage
	subtitle: "",
	...
	favicon: [
		...
		{
			src: "/favicon/cat2.jpg", // Path of the favicon, relative to the /public directory
	...
	links: [
		{
			...
			url: "https://www.instagram.com/rui._0113/",
		},
		{
			name: "Discord",
